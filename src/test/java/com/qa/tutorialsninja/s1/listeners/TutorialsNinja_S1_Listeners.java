package com.qa.tutorialsninja.s1.listeners;
...
import com.qa.tutorialsninja.s1.utilities.TutorialsNinja_S1_ExtentReports;

public class TutorialsNinja_S1_Listeners implements ITestListener{
	...
	public void onStart(ITestContext context) {
		try {
			extentReport = TutorialsNinja_S1_ExtentReports.generateNinjaS1EntentReport();
		} catch (Exception e) {
