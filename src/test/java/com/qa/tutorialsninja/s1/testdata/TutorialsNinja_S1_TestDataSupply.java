package com.qa.tutorialsninja.s1.testdata;
...
public class TutorialsNinja_S1_TestDataSupply {
	
	public static FileInputStream ip;
	public static XSSFWorkbook workbook;
	public static XSSFSheet sheet;
	
	@DataProvider(name = "TutorialsNinja_S1_DataProvider_DataSupply")
	...
	public static Object [][] dataSupplyFromExcelSheet() throws Exception{
		Object [][] data = TutorialsNinja_S1_TestDataSupply.getTutorialsNinjaTestDataFromExcelSheet("LoginData");
		return data;
	}
	public static Object [][] getTutorialsNinjaTestDataFromExcelSheet(String sheetName) throws Exception{
		ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\test\\java\\com\\qa\\tutorialsninja\\s1\\testdata\\TutorialsNinja_S1_TestData.xlsx");
