...
public class TutorialsNinja_S1_ExtentReports {
	...
	FileInputStream reportIp = new FileInputStream(System.getProperty("user.dir") + "\\src\\main\\java\\com\\qa\\tutorialnsninja_s1\\configurations\\tutorialsninja_S1_configurations.properties");
	...
	extentReport.setSystemInfo("Valid Email", reportProp.getProperty("validUsername"));
